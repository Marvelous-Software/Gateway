...
<?php define( 'CONSULTUP_THEME_DIR', get_template_directory() . '/' );
	...
	//update_option( 'siteurl', 'http://localhost/Wordpress/johnm5.sgedu.site/public_html/' );
	//update_option( 'home', 'http://localhost/Wordpress/johnm5.sgedu.site/public_html/' );
	...
	define("ABOUT", "http://johnm5.sgedu.site/wp-content/uploads/2020/12/old-and-new-computer.png");
	...
	define("CONTACT", "http://johnm5.sgedu.site/wp-content/uploads/2020/12/Contact.png");
	...
	function change_the_header($url_for_image) {
		...
		if (is_page(HOME_ID)) {
			...
			$url_for_image = EVENT;
		} else if (is_page(CONTACT_ID)) {
			$url_for_image = CONTACT;
		}
	else {
