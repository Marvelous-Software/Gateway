...
function webstrap_home_feature_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'features_title', array(
		...
		'render_callback'  => 'webstrap_features_title_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'features_description', array(
		...
		'render_callback'  => 'webstrap_features_description_render_callback',
...
// features_title
function webstrap_features_title_render_callback() {
	return get_theme_mod( 'features_title' );
}
// features_description
function webstrap_features_description_render_callback() {
