...
function webstrap_premium_setting( $wp_customize ) {
	...
	class Webstrap_Buttons_Customize_Control extends WP_Customize_Control {
	public $type = 'upgrade_premium';
	   ...
	   function render_content() {
		?>
			...
			<div>
				<ul>
					<li><a href="http://docs.speciatheme.com/themes/webstrap-free/" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/documentation.png"></a></li>
					
					<li><a href="https://wordpress.org/support/theme/webstrap/reviews/#new-post" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/rating.png"></a></li>
				</ul>
			</div>
		<?php
	   }
		...
		$wp_customize->add_control( new Webstrap_Buttons_Customize_Control( $wp_customize, 'premium_info_buttons', array(
