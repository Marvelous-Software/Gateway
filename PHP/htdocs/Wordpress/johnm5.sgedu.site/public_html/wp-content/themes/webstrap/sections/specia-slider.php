<?php 
	$webstrap_hs_slider= get_theme_mod('hide_show_slider','on');
	if( $webstrap_hs_slider == 'on' ): 
?>
					...
					<div class="container inner-table">
						<div class="inner-table-cell">
							<div class="caption verticle-center text-center wow zoomIn">
								...
								<?php echo wp_filter_post_kses($content); ?>
								
								<?php if( get_post_meta(get_the_ID(),'webstrap_slidebutton', true ) ): ?>
									<a href="<?php echo esc_url( get_post_meta( get_the_ID(),'webstrap_slidebutton', true) ); ?>" class="specia-btn-1">
										<?php echo esc_html_e( 'Read More','webstrap' ); ?> 
									</a>
								<?php
									endif;
								?>
